import numpy as np
from addon_seg_evaluation.UNETmodel import UNet, UNet_filters
...
class Segmentation():
    ...
    def __init__(self, img_shape=None, **kwargs):
        self.unet = UNet_filters().create_model((img_shape[0], img_shape[1], 1), 1, d=1)
        network_path ="/home/user/Downloads/Unet_andy_Unet_1_everywhere_filters_n200_20201102-160251.h5"
