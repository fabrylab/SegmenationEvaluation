...
class Segmentation():
    ...
    def __init__(self, img_shape=None, pixel_size=None, r_min=None, frame_data=None, edge_dist=15, channel_width=0,
        ...
        network_path = "/home/user/Desktop/2020_Deformation_Cytometer/models_local/background_weighting_with_custom_function/Unet_andy_Unet_class_weight_like_cw0_5_20201109-194939.h5"
